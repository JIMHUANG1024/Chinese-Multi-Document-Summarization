...
class Trainer(object):
    ...
    def train(self, train_iter_fct, validate_iter_fct, train_steps):
        ...
        while step <= train_steps:
                ...
                if self.n_gpu == 0 or (i % self.n_gpu == self.gpu_rank):
                    ...
                    if accum == self.grad_accum_count:
                        ...
                        report_stats = self._maybe_report_training(
                            ...
                            report_stats)
                        if i % 500 == 0:
                            total_stats.output(step, train_steps, self.optim.learning_rate, total_stats.start_time)
                            print(f'setp:{step}, i:{i}')
            ...
            self._report_step(0, train_steps, valid_stats=valid_stats)
            if valid_stats.ppl() < ppl:
                ppl = min(valid_stats.ppl(), ppl)
                self._save(train_steps)
